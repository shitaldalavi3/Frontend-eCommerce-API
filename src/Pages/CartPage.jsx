      ...
      <table className="min-w-full border border-gray-300 border-collapse">
        <thead>
          <tr className="bg-gray-100">
            <th className="border border-gray-300 py-2 px-4 text-left">Product</th>
            <th className="border border-gray-300 py-2 px-4 text-left">Quantity</th>
            <th className="border border-gray-300 py-2 px-4 text-left">Price</th>
            <th className="border border-gray-300 py-2 px-4 text-left">Total</th>
        ...
        <tbody>
          {cart.map((item) => (
            <tr key={item._id} className="hover:bg-gray-50">
              ...
              <td className="border border-gray-300 py-2 px-4">€{item.price * item.quantity}</td>
